...
Let's make sure Hugo is set up as expected. You should see a similar version number in your terminal (I like Spiritualized):

![Color palette](content/static/Loomlogo.png)
